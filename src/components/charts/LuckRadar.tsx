...
export default function LuckRadar() {
  return (
    <Card className="pb-2 xl:px-0 flex flex-col h-full">
      ...
      <div className="flex-grow flex flex-col pb-0 xl:flex-row">
        ...
        <CardFooter className="flex flex-col gap-2 text-sm xl:flex-[60%] items-start justify-center pt-0 sm:pb-8 xl:py-0 xl:mb-12 xl:pl-4">
          <div className="flex items-center gap-2 leading-none pb-2">
      ...
      <div className="text-xs text-center pb-3 text-muted-foreground/60">SIGNALTRACKER.GG</div>
    </Card>
  );
}
